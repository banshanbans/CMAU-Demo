...
const steps = [
  {
    ...
    hint: {
      title: '这会影响你的准备节奏',
      body: '本科、硕士、Gap 和在职申请者的准备重点不同，我们会据此调整建议。',
    },
  },
  {
    section: '深造意向',
  ...
  },
  {
    ...
    hint: {
      title: '科研背景会影响建议',
      body: '科研经历会影响项目选择、导师沟通和材料表达，越早梳理越容易安排提升计划。',
    },
  },
  {
    section: '申请准备度',
    ...
    hint: {
      title: '准备状态影响服务优先级',
      body: '不同阶段需要不同任务：探索期重在方向，冲刺期重在材料和节奏。',
    },
  },
  {
    section: '心理状态',
    title: '你现在的申请焦虑程度？',
    question: '选择最接近你最近一段时间的状态',
    multi: false,
    options: [
    ...
    hint: {
      title: '焦虑感是正常的',
      body: '申请压力会影响执行节奏。了解你的状态后，建议会更关注可完成的近期任务。',
    },
  },
]
