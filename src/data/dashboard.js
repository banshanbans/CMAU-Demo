...
export const dashboardMessages = [
  {
    ...
    cta: '查看报告',
    detail:
      '最新报告已结合你的测评结果、当前服务阶段和任务推进情况完成更新。建议优先查看“方向清晰度”和“时间规划”两个维度的变化，再决定下一轮训练重点。',
  },
  {
    id: 'msg-mentor',
    type: 'mentor',
  ...
  },
  {
    ...
    cta: '立即报名',
    detail:
      '本次研讨会将围绕 AI+教育、社会学+数据分析等方向展开，适合目前处于方向探索期和科研起步期的学生。',
  },
  {
    id: 'msg-review',
    type: 'system',
  ...
  },
  {
    ...
    cta: '查看资源',
    detail:
      '当前推荐更适合“教育心理交叉”方向。若你准备进一步锁定问题意识，可以先从这两个导师画像对应的研究主题入手。',
  },
  {
    id: 'msg-reminder',
    type: 'event',
...
export const resourceCards = [
  {
    ...
    desc: '更适合正在从教育学或心理学课程背景过渡到研究问题聚焦的学生。',
    tags: ['方向初步', 'PhD 意向'],
    status: '推荐中',
  },
  {
    type: '实验室机会',
    title: '学习分析方向线上助研机会',
    desc: '适合希望补充研究协作经历、但暂时还无法进入线下课题组的学生。',
    tags: ['科研空白', '备战期'],
    status: '可申请',
  },
  {
    type: '公开活动',
    title: '跨学科研究趋势线上研讨会',
    desc: '帮助你判断“AI+教育”和“社会学+数据分析”类交叉主题的表达方式。',
    tags: ['方向不清', '高焦虑'],
    status: '已收藏',
  },
  {
